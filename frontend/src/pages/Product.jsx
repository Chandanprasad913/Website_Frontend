      ...
      <div className="flex flex-col gap-12 sm:flex-row sm:gap-12">
        ...
        <div className="flex flex-1 flex-col-reverse gap-3 sm:flex-row">
          ...
          <div className="w-full sm:w-[80%]">
            <img src={image} className="m-auto h-auto w-full" alt="" />
          </div>
        </div>
        {/* //* Product Info */}
        <div className="flex-1">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  className={`cursor-pointer border bg-gray-100 px-4 py-2 ${item === size ? "border-orange-500 bg-orange-100" : ""}`}
                  key={index}
                >
                  {item}
                </button>
          ...
          <button className="cursor-pointer bg-black px-10 py-4 text-sm text-white active:scale-95 active:bg-gray-700">
            Add to Cart
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm">
          <p>
            ...
            Quibusdam itaque quasi iusto quam enim cumque quis ipsa perferendis,
            maiores consequatur.
          </p>
          <p>
            {" "}
            ...
            saepe cupiditate aliquid, ipsum nisi maiores quam!
          </p>
        </div>
      </div>
